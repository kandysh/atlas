...
> {
  try {
    ...
    logger.error({ workspaceId, page, error }, 'Error fetching tasks');
...
export async function createTask(
  ...
  try {
    ...
    logger.error({ workspaceId, error }, 'Error creating task');
...
export async function updateTask(
  ...
  try {
    ...
    logger.error({ taskId, error }, 'Error updating task');
...
export async function deleteTask(
  ...
  try {
    ...
    logger.error({ taskId, error }, 'Error deleting task');
...
> {
  try {
    ...
    logger.error({ taskIds, error }, 'Error deleting tasks');
...
export async function duplicateTask(
  ...
  try {
    ...
    logger.error({ taskId, error }, 'Error duplicating task');
...
> {
  try {
    ...
    logger.error({ taskId, error }, 'Error fetching task events');
